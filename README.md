...
* 使用[xray](https://github.com/XTLS/Xray-core)+caddy  shadowsocks  
* 支持tor网络，且可通过自定义网络配置文件启动xray和caddy来按需配置各种功能  
* 支持存储自定义文件,目录及账号密码均为AUUID,客户端务必使用TLS连接  
 
 (https://dashboard.heroku.com/new?template=https://github.com/Abrakian/Codeine-runneth-over-on-my-nightstand)  
